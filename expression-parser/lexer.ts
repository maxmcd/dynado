...
// Function names
export const AttributeExists = createToken({ name: "AttributeExists", pattern: /attribute_exists\b/ });
export const AttributeNotExists = createToken({ name: "AttributeNotExists", pattern: /attribute_not_exists\b/ });
export const BeginsWith = createToken({ name: "BeginsWith", pattern: /begins_with\b/ });
export const Contains = createToken({ name: "Contains", pattern: /contains\b/ });
export const Size = createToken({ name: "Size", pattern: /size\b/ });
export const AttributeType = createToken({ name: "AttributeType", pattern: /attribute_type\b/ });
export const IfNotExists = createToken({ name: "IfNotExists", pattern: /if_not_exists\b/ });
export const ListAppend = createToken({ name: "ListAppend", pattern: /list_append\b/ });
